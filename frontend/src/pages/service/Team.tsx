...
export default function team() {
  ...
  const slides = [
    { id: 0, content: <img src={haejin} alt="haejin" />, background: "#f0f568", name: '김혜진', position:'BE'},
    { id: 1, content: <img src={jaew} alt="jaew" />, background: "#ffc2c2", name: '조재웅', position:'BE'},
    { id: 2, content: <img src={daeyoung} alt="daeyoung" />, background: "#b3ede5", name: '임대영', position:'BE' },
    { id: 3, content: <img src={junha} alt="junha" />, background: "#aeffae", name: '조준하',position:'FE' },
    { id: 4, content: <img src={shee} alt="shee" />, background: "#eaa0dc", name: '박승희', position:'FE' },
    { id: 5, content: <img src={sw} alt="sw" />, background: "#b5d4f9", name: '이성원', position:'FE' },

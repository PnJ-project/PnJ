  ...
  reducers: {
    ...
    updateEvent: (state, action: PayloadAction<UpdateEvent>) => {
      ...
      if (
        ...
        state.events[index].memo = action.payload.memo
          ? action.payload.memo
          : action.payload.resource.event.memo;
        state.events[index].colorId = action.payload.colorId
          ? action.payload.colorId
          : action.payload.resource.event.colorId;

...
const handleSlice = createSlice({
  ...
  reducers: {
    ...
    selectRangeDate: (state, action: PayloadAction<{ rangeStart: string; rangeEnd: string }>) => {
...
export const setSelectDate = (state: RootState) => state.handledate.handleRangeDate;
